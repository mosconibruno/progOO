...
public class ClienteDAO {
	...
	public void createCliente() throws SQLException {
		String sql = "CREATE TABLE Cliente ( "
				...
				+ "nome varchar(30), sobrenome varchar(30) );";
		PreparedStatement ps = conn.prepareStatement(sql);
		ps.execute();
		ps.close();
	}
	...
	public Cliente listarUmCliente(int id) throws SQLException {
		...
		return new Cliente(rs.getInt("id"), rs.getString("nome"), rs.getString("sobrenome"));
	}
	...
	public void alterarNomeCliente(int id, String nome) throws SQLException {
		String sql = "UPDATE from Cliente SET nome=? WHERE id=?;";
		PreparedStatement ps = conn.prepareStatement(sql);
		ps.setString(1, nome);
		ps.setInt(2, id);
		ps.execute();
